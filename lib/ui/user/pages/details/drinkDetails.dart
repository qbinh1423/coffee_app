...
Future<Uint8List> loadNetworkDrinkImage(String url) async {
...
class _DrinkDetailsState extends State<DrinkDetails> {
  Future<void> generatePDF() async {
    ...
    final Uint8List imageBytes = await loadNetworkDrinkImage(widget.imageUrl);
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Text('Ingredients:',
                  style: pw.TextStyle(
                      fontSize: 18, fontWeight: pw.FontWeight.bold)),
              pw.Text(widget.ingredient ?? "No ingredients"),
            ],
          );
        },
      ),
    ...
    final file = File("${output.path}/${widget.drinkName}.pdf");
    await file.writeAsBytes(await pdf.save());

    Share.shareXFiles([XFile(file.path)],
        text: "You receive a share file about drink: ${widget.drinkName}");
  }
